            ...
            <div class="col-lg-7 col-md-7">
                ...
                <div class="product_description">
                    ...
                    <div class="product_price">
                        <span class="price product-sale-price-text">{{ format_price($product->front_sale_price) }}</span>
                        <del class="product-price-text" @if ($product->front_sale_price == $product->price) style="display: none" @endif>{{ format_price($product->price) }}</del>
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div id="list-reviews">
                                    <div class="comments">
                                        ...
                                        <product-reviews-component url="{{ route('public.ajax.product-reviews', $product->id) }}?limit=10&page={{ request()->input('page', 1) }}"></product-reviews-component>
                                    </div>
                                </div>
