                ...
                <div class="wrapper-content pd-all-20">
                    ...
                    <div v-if="!isLoading && !verified">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" v-model="buyer" id="buyer" placeholder="Your Envato's username (https://codecanyon.net/user/{username})">
                            <div>
                                <small>Ex: Your profile page is https://codecanyon.net/user/john-smith, then your Envato username is <strong>john-smith</strong></small>
                            </div>
                        </div>
                        <div class="form-group">
