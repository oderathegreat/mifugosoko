        ...
        <td class="border-right">
            <ul>
                <li>
                    ...
                    <p>{{ __('Customer can buy product and pay directly using Visa, Credit card via Paystack') }}</p>
                </li>
            </ul>
        </td>
    </tr>
                            ...
                            <ul class="m-md-l" style="list-style-type:decimal">
                                <li style="list-style-type:decimal">
                                    <a href="https://paystack.com" target="_blank">
                                        {{ __('Register an account on Paystack') }}
                                    </a>
                                </li>
                                <li style="list-style-type:decimal">
                    ...
                    <div class="well bg-white">
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="payment_{{ PAYSTACK_PAYMENT_METHOD_NAME }}_name"
                                   ...
                                   value="{{ get_payment_setting('name', PAYSTACK_PAYMENT_METHOD_NAME, __('Online payment via Paystack')) }}">
                        </div>
                        ...
                        <div class="form-group">
                            <label class="text-title-field" for="paystack_public">{{ __('Public Key') }}</label>
                            <input type="text" class="next-input"
                                   name="payment_{{ PAYSTACK_PAYMENT_METHOD_NAME }}_public" id="paystack_public"
                                   value="{{ get_payment_setting('public', PAYSTACK_PAYMENT_METHOD_NAME) }}">
                        </div>
                        <div class="form-group">
                            <label class="text-title-field" for="paystack_secret">{{ __('Secret Key') }}</label>
                            <input type="password" class="next-input" placeholder="••••••••" id="paystack_secret"
                                   name="payment_{{ PAYSTACK_PAYMENT_METHOD_NAME }}_secret"
                                   value="{{ get_payment_setting('secret', PAYSTACK_PAYMENT_METHOD_NAME) }}">
                        </div>
                        <div class="form-group">
                            <label class="text-title-field" for="paystack_merchant_email">{{ __('Merchant Email') }}</label>
                            <input type="email" class="next-input" placeholder="{{ __('Email') }}" id="paystack_merchant_email"
                        ...
                        <p class="payment-note">
                            You will need to set Callback URL on <a href="https://dashboard.paystack.com/#/settings/developer">https://dashboard.paystack.com/#/settings/developer</a> to <strong><code>{{ route('paystack.payment.callback') }}</code></strong>
                        </p>
                    </div>
                </div>
            </div>
