...
@section('content')
    <div class="max-width-1200">
            ...
            <div class="ui-layout__item mb20">
                <div class="ui-banner ui-banner--status-warning">
                    ...
                    <div class="ui-banner__content">
                        <h2 class="ui-banner__title">{{ __('Shipment was canceled') }}</h2>
                        <div class="ws-nm">
                            {{ __('At') }} <i>{{ BaseHelper::formatDate($shipment->updated_at, 'H:i d/m/Y') }}</i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flexbox-grid no-pd-none">
                    ...
                    <div class="shipment-actions">
                        <div class="dropdown btn-group">
                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <span class="mr5">{{ __('Update shipping status') }}</span>
                        ...
                        @if ($shipment->cod_amount)
                            <div class="dropdown btn-group p-l10">
                                <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <span class="mr5">{{ __('Update COD status)') }}</span>
                                    <span class="caret"></span>
                                </button>
                                <div class="dropdown dropdown-menu dropdown-ps-left applist-style animate-scale-dropdown min-width-200-px" role="menu" aria-labelledby="dropdownfilter">
                                    <div>
            ...
            <div class="flexbox-content flexbox-right">
                <div class="wrapper-content">
                    <div class="pd-all-20">
                        <label class="title-product-main text-no-bold">{{ __('Shipment information') }}</label>
                    </div>
                ...
                <div class="wrapper-content mt20">
                    <div class="pd-all-20">
                        <label class="title-product-main text-no-bold">{{ __('Customer information') }}</label>
                    </div>
                    <div class="pd-all-20 p-t15 p-b15 border-top-title-main ps-relative">
    ...
    {!! Form::modalAction('confirm-change-status-modal', __('Confirm <span class="shipment-status-label"></span> ?'), 'info', __('Are you sure you want to confirm <span class="shipment-status-label"></span> for this shipment?'), 'confirm-change-shipment-status-button', __('Accept')) !!}
@stop
