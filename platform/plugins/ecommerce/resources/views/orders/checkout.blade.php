...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/core/plugins/payment/css/payment.css') }}?v=1.0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 float-right">
                                <p class="total-text raw-total-text"
                                   data-price="{{ Cart::instance('cart')->rawTotal() }}"> {{ format_price(Cart::instance('cart')->rawTotal() - $promotionDiscountAmount - $couponDiscountAmount + $shippingAmount) }} </p>
                            </div>
                        </div>
    ...
    @endif
    <script src="{{ asset('vendor/core/plugins/payment/js/payment.js') }}?v=1.0"></script>
