...
<ul class="wc_status_list">
    <li class="sales-this-month">
        <a href="{{ route('ecommerce.report.index') }}">
                ...
                </strong> {{ __('Revenue this month') }}
        </a>
    </li>
    <li class="processing-orders">
        <a href="{{ route('orders.index') }}">
            <strong>{{ $processingOrders }} {{ Str::plural(__('order') , $processingOrders) }}</strong> {{ __('processing in this month') }}
        </a>
    </li>
    <li class="completed-orders">
        <a href="{{ route('orders.index') }}">
            <strong>{{ $completedOrders }} {{ Str::plural(__('order') , $completedOrders) }}</strong> {{ __('completed in this month') }}
        </a>
    </li>
    <li class="low-in-stock">
        <a href="{{ route('products.index') }}">
            <strong>{{ $lowStockProducts }} {{ Str::plural(__('product') , $lowStockProducts) }}</strong> {{ __('will be out of stock soon') }}
        </a>
    </li>
    <li class="out-of-stock">
        <a href="{{ route('products.index') }}">
            <strong>{{ $outOfStockProducts }} {{ Str::plural(__('product') , $outOfStockProducts) }}</strong> {{ __('out of stock') }}
        </a>
    </li>
</ul>
