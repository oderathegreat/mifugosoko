    ...
    public function run()
    {
        ...
        $products = [
            [
                ...
                'sale_price'     => 55,
                'is_featured'    => true,
                'featured_image' => 'products/f-1.jpg',
            ],
            [
                'name'           => 'Smart Watches',
                ...
                'sale_price'     => 35,
                'is_featured'    => true,
                'featured_image' => 'products/f-2.jpg',
            ],
            [
                'name'           => 'Beat Headphone',
        ...
        foreach ($products as $item) {
            ...
            $product = Product::create(Arr::except($item, ['featured_image']));

            if ($product->is_featured) {
                MetaBox::saveMetaBoxData($product, 'featured_image', $item['featured_image']);
            }
